...
Native call guidance and internet calling are distinct; never infer chosen SIM, connectivity or completed call from launching the phone dialer.
...
4. Explain selecting the line for native calls/data on dual-SIM devices. The internet dialer is owned by V04; link to it only when accepted and enabled. Do not claim silent installation on unmanaged phones.
