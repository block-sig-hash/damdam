...
Personal browser calling needs no organization membership. Work-call grants/history and revocation use object-level tenant/payer scope; V02 implements calling-specific checks.
