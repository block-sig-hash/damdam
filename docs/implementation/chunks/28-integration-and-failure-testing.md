...
For released internet channels require V02–V05 acceptance and the amendment failure matrix. Include concurrent app/browser spending, copied grants, client/worker loss, late CDR and cross-mode exposure if enabled.
