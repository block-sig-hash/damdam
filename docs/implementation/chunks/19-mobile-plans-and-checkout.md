...
Allow eligible internet-only checkout without handset/eSIM compatibility gating. Show mode-specific tariff and identity terms and preserve the same seller/payment rules.
