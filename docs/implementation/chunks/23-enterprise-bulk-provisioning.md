...
For internet-only assignment, provision the service grant without purchasing a carrier profile. Carrier activation remains a separate capability with unchanged evidence gates.
