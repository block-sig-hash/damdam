...
Shared account/receipts/support work may split from carrier-only chunk20 scope for an internet-first release. Include active call liabilities and grant revocation in deletion/export; do not delete pending settlement records.
