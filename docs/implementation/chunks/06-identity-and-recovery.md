...
Support recovery and sessions for internet-only customers with no eSIM or assigned number. Define the browser consumer session contract used by V05; V02 owns calling-specific grants.
