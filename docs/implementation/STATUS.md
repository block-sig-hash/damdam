...
| 29 — Run the authorized physical-device and enterprise pilot | **READY_FOR_REVIEW for preparatory runbook and EAS-signing guard only; live pilot EXTERNAL_BLOCKED** | base `33a9fce` / review head pending | [Assignment](chunks/29-physical-device-and-enterprise-pilot.md), [runbook](release/29-PILOT-RUNBOOK.md), [blank evidence](release/29-PILOT-EVIDENCE.md), [handoff](handoffs/29.md) | Founder confirms no approved EAS project/signing/testers and no live carrier/merchant/spending authorization. No cloud signed builds, TestFlight/Play invites, physical installs, enterprise pilot or real eSIM/data/native-call evidence. Native CI from chunk 28 is preparatory only; chunk 29 exact-head CI pending |
