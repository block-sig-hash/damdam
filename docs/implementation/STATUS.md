...
| 28 — Prove integrated flows, migrations and failure recovery | **READY_FOR_REVIEW** (simulated/software integration scope); physical/live scope **EXTERNAL_BLOCKED** | accepted preparatory base `f65be27` / implementation `18b6f9c` | [Handoff](handoffs/28.md), [draft PR #135](https://github.com/block-sig-hash/damdam/pull/135) | Exact-head CI passed API 1,733 tests at 89.92% coverage, mobile/dashboard and both native screenshot jobs; populated legacy-to-head and restart-to-usage PostgreSQL regressions added. D1–D6, real devices/carrier/merchant, signed EAS and internal distribution remain open; independent review pending |
