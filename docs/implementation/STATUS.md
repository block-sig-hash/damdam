...
| 12 — Implement payment routing and modernize Paystack | **READY_FOR_REVIEW** | rebased onto chunk 11 / see [handoff](handoffs/12.md) | Not reviewed | **D3/D4 OPEN** — `live_enabled` is false and constrained; no live or sandbox Paystack call made |
