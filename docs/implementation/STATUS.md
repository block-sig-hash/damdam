...
| 29 — Run the authorized physical-device and enterprise pilot | NOT_STARTED | — | [Assignment](chunks/29-physical-device-and-enterprise-pilot.md) | Arrange authorized TestFlight and Android internal testing with consenting physical-device owners; real eSIM, cellular-data and native-call evidence remains a hard gate, not replaceable by EAS or generic labs |
