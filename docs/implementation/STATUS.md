...
| 27 — Update signed builds, privacy disclosures and release automation | **CHANGES_REQUIRED after fifth independent review**; corrected preparatory scope awaiting exact-head native CI; signed/live release evidence **EXTERNAL_BLOCKED** | base `247974b` / initial implementation `3f95b09` / correction pending | [Implementation handoff](handoffs/27.md), [distribution worklist](release/27-SIGNING-PRIVACY.md) | D1–D6: EAS cloud builds and approved iOS/Android signing still unverified; iOS simulator automation pending; no physical provider/merchant/market/legal evidence; dedicated status App, protected environment, external release key, strict required status and merge queue need admin bootstrap |
