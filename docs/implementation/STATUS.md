...
| 06 — Implement global identity and account recovery | **READY_FOR_REVIEW** (backend scope); mobile client work deliberately deferred to 06B | base `d2f5349` / see [handoff](handoffs/06.md) | Not reviewed | Launch identity method **decided 2026-09-09** (email); live email delivery still gated |
