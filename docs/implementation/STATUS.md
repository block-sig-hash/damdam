...
| 13 — Implement the selected global payment adapter and wallet checkout | **EXTERNAL_BLOCKED** (provider half); conformance suite and adapter boundary READY_FOR_REVIEW | rebased onto chunk 12 / see [handoff](handoffs/13.md) | Not reviewed | **D4 OPEN — no processor selected.** Sandbox checkout and wallet/device evidence NOT PROVIDED |
