...
| 14 — Implement refunds, disputes, bank funding and receipts | **READY_FOR_REVIEW** | rebased onto chunk 13 / see [handoff](handoffs/14.md) | Not reviewed | **D5 OPEN** — `policy_reference` records a policy, it does not compute entitlement; **D3 OPEN** — no seller entity seeded, no tax treatment. No processor refund call made or contract-checked |
