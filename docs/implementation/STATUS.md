...
| 27 — Update signed builds, privacy disclosures and release automation | **CHANGES_REQUIRED after fifth independent review**; corrected preparatory scope awaiting fresh review/CI; signed/live release evidence **EXTERNAL_BLOCKED** | base `247974b` / initial implementation `3f95b09` / correction pending | [Implementation handoff](handoffs/27.md) | D1–D6: no approved distribution signing, physical devices, provider/merchant/market/legal evidence or store disclosure approval; dedicated status App, protected environment, external release key, strict required status and merge queue need admin bootstrap |
